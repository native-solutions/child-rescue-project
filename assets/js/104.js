...
$(".triangle3Ex5,.Oval2Ex5, .triangle4Ex5").delay(21600).fadeIn(500);
  ...
  /* Ex6 */
$(".Banner6").delay(500).fadeIn(500);
$(".BannerHolderEx6").delay(500).fadeIn(500);
$(".BannerBorderEx6,.BannerBorderLineEx6").delay(2500).fadeIn(500);
$(".SaleEx6").delay(1000).fadeIn(500);
$(".circleEx6").delay(800).fadeIn(500);
$(".OffEx6").delay(1000).fadeIn(500);
